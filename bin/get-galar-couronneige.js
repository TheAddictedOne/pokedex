...
const DEST = path.resolve(__dirname, '../data/galar-couronneige.json')
const URL = 'https://www.pokepedia.fr/Liste_des_Pok%C3%A9mon_dans_l%27ordre_du_Pok%C3%A9dex_de_Couronneige'
